...
<style>
  ...
  * {{ margin: 0; padding: 0; box-sizing: border-box; }}
  ...
  @media print {{
    ...
    /* Hero: pull up to cover page top margin */
    ...
    /* Facts: 2cm gap */
    .facts-bar {{ padding: 8px 0 !important; break-inside: avoid; display: flex !important; flex-wrap: nowrap !important; justify-content: center !important; gap: 2cm !important; }}
    .fact {{ min-width: auto !important; flex: none !important; text-align: center !important; }}
    .fact-value {{ font-size: 24pt !important; line-height: 1 !important; }}
    .fact-label {{ font-size: 14pt !important; margin-top: 1px !important; }}

    #about-section p:nth-child(n+5) {{ display: none; }}

    /* Bedroom cards: room 12pt, bed 10pt */
