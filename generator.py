...
<style>
  ...
  * {{ margin: 0; padding: 0; box-sizing: border-box; }}
  ...
  @media print {{
    ...
    body {{ font-size: 10pt; background: white !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 10mm !important; }}
    .container {{ max-width: 100%; padding: 0 10px; }}

    /* Hero: full width including over padding */
    .hero {{ height: 280px !important; margin: -10mm -10mm 0 -10mm !important; width: calc(100% + 20mm) !important; }}
    .hero-overlay h1 {{ font-size: 26pt; }}
    .hero-overlay .location {{ font-size: 10pt; }}

    /* Facts bar: keep with hero */
    .facts-bar {{ padding: 14px 0; break-inside: avoid; }}
    ...
    /* Gallery: keep rows together, not the whole gallery */
    .gallery-grid {{ break-inside: auto; }}
    .gallery-grid img {{ max-height: 180px; }}
    .gallery-row-2, .gallery-row-3 {{ break-inside: avoid; margin-bottom: 4px; }}

    /* Services: let it flow */
